...
int main(){
  ...
  require(r1.best_move == r2.best_move, "tuned deterministic best move");
  require(r1.score == r2.score, "tuned deterministic score");
  ...
  std::cout<<"tuning regression passed: futility 200 deterministic\n";
  return 0;
}